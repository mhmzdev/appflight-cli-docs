...
- **Flutter** — reads `version` from `pubspec.yaml` (e.g. `1.2.3+45`)
- **React Native** — reads `versionName` + `versionCode` from `android/app/build.gradle` and combines them as `1.2.3+45`
